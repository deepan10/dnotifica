package com.dnotifica.notification.notificationwindow;
...
public class NotificationWindow extends JWindow
{
  ...
  private void initManager() {
	    ...
	    ImageIcon closeIcon = new ImageIcon(
	    		new ImageIcon(NotificationWindow.class.getResource("/com/dnotifica/notification/resources/close.png"))
	    		.getImage()
